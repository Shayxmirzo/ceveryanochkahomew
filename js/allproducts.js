...
let prodwithoutdis = document.getElementById("prodwithoutdis")
...
function renderdis(content, data){
    content.innerHTML = ""
   data
...
renderdis(prodiscount, products)
function renderwithoutdis(content, data){
    content.innerHTML = ""
   data
    .filter(el => el.discount === 0)
    .forEach(el => {
...
renderwithoutdis(prodwithoutdis, products)
